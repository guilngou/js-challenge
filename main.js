var startDate = new Date(2018,6,1,10,30); // July 1st, 10:30
var endDate = new Date(2018,6,1,14,00); // July 1st, 14:00
...
var fromDate = new Date(2018,7,4,10,00);
var toDate = new Date(2018,7,10,10,00);
